...
class login_system:
    ...
    # Create Widgets
        ...
        self.bg1_icon=ImageTk.PhotoImage(file="L.jpg")

        self.bg_icon=ImageTk.PhotoImage(file="L.jpg")
        self.user_icon=ImageTk.PhotoImage(file="u1.png")
        self.pass_icon=ImageTk.PhotoImage(file="p1.jpg")
